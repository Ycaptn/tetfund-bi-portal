...
<div class='btn-group' role="group">
    ...
    @if($is_desk_officer_check==1 && $is_average_committee_members_check==0 && auth()->user()->hasRole('bi-astd-committee-head') && (isset(request()->view_type) && request()->view_type == 'committee_head_consideration' ))
        <a data-toggle="tooltip" 
