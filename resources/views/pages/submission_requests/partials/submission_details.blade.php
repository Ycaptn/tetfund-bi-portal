            ...
            <div class="col-sm-12">
                <div class="row">
                   ...
                   {{--  @if(($submissionRequest->status=='approved' || $submissionRequest->status=='submitted' || $submissionRequest->status=='recalled') && !empty($submitted_request_data) && $submitted_request_data->has_generated_aip==false && $submitted_request_data->has_generated_disbursement_memo==false)
                    ...
                    @if(in_array($submissionRequest->status, ['not-submitted', 'submitted', 'recalled', 'approved']) && 
                    ...
                    !empty($submitted_request_data) /* && $submitted_request_data->has_generated_aip==false*/ && $submitted_request_data->has_generated_disbursement_memo==false && (in_array($submissionRequest->status, ['pending-recall', 'approved']) || $submitted_request_data->request_status!='recalled'))
