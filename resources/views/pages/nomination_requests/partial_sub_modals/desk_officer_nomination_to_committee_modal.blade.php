...
@push('page_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //process bulk nomination forwarding to committee
            $(document).on('click', ".move_all_for_consideration", function(e) {
                e.preventDefault();
                $.ajaxSetup({headers: {'X-CSRF-TOKEN': $('input[name="_token"]').val()}});
                ...
                swal({
                    title: "Are you sure you want to forward all request to " + itemType + " committee for consideration?",
                    text: "You will not be able to revert this process once initiated.",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonClass: "btn-danger",
                    ...
                    if (isConfirm) {
                        ...
                        swal({
                            title: '<div id="spinner-beneficiaries" class="spinner-border text-primary" role="status"> <span class="visually-hidden">  Loading...  </span> </div> <br><br> Please wait...',
                            text: 'Forwarding all request to ' + itemType + ' committee members! <br><br> Do not refresh this page! ',
                            showConfirmButton: false,
                            allowOutsideClick: false,
                            html: true
                        });
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                if(result.errors){
                                    ...
                                    swal({
                                        title: "Forwarded",
                                        text: "All Request forwarded to " + itemType + " committee for consideration",
                                        type: "success",
                                        confirmButtonClass: "btn-success",
                                        confirmButtonText: "OK",
                                        closeOnConfirm: false
