...
class TFBiSubmittedBeneficiaryRequestMigration extends Command
{
    protected $signature = 'tetfund:bi-submitted-beneficiary-requests-migration';
    protected $description = 'Migrates submitted_beneficiary_requests from TETFund_Iterum_Portal database to TETFund_BI-Portal submissions';
    ...
    public function handle() {
        ...
        echo "Running Submitted Beneficiary Requests Migration from TETFund_Iterum_Portal to Submission Request on TETFund_Beneficiary_Portal \n";
        ...
        echo ">>> Found {$beneficiary_requests_count} Submitted Beneficiary Request Records for TETFund-BI-Portal Replication \n \n \n";
        ...
        foreach($iterum_beneficiary_requests as $idx=>$iterum_beneficiary_request){
            ...
            try {
                ...
                if ($bi_portal_beneficiary != null) {
                    ...
                    echo "Skipping - Submitted Beneficiary Request Record - ERROR - Could not replicate Beneficiary Request \n";
                    if ($bi_portal_beneficiary == null) {
        ...
        echo "{$beneficiary_requests_count} Iterum-Portal Submitted Beneficiary requests detected \n";
        ...
        echo "Done Submitted Beneficiary Request Migration \n \n \n \n ";
