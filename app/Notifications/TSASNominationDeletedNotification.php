...
class TSASNominationDeletedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('TSASNomination deleted successfully')
                                ->markdown(
                                    'mail.tSASNominations.deleted',
