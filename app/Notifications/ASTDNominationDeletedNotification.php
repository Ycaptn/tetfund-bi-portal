...
class ASTDNominationDeletedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('ASTDNomination deleted successfully')
                                ->markdown(
                                    'mail.aSTDNominations.deleted',
