...
class ASTDNominationUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('ASTDNomination updated successfully')
                                ->markdown(
                                    'mail.aSTDNominations.updated',
