...
class TSASNominationUpdatedNotification extends Notification
{
    ...
    {
        return (new MailMessage)->subject('TSASNomination updated successfully')
                                ->markdown(
                                    'mail.tSASNominations.updated',
