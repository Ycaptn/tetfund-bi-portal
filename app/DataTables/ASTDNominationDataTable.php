...
class ASTDNominationDataTable extends DataTable
{
     ...
     *
     * @param \App\Models\ASTDNomination $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ASTDNomination $model)
    {
    ...
    {
        return 'a_s_t_d_nominations_datatable_' . time();
    }
}
