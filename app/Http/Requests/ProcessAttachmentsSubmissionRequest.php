     ...
     public function rules() {
        ...
        if(request()->checklist_input_fields != "") {
            ...
            foreach ($checklist_input_fields_arr as $checklist_input_name) {
                $array_to_return[strval($checklist_input_name)] = 'sometimes|file|mimes:pdf,doc,docx,xls,xlsx,ppt,pptx,twg|max:102400';
            }
        ...
        $array_to_return['additional_attachment'] = 'sometimes|file|mimes:pdf,doc,docx,xls,xlsx,ppt,pptx,twg|max:102400';
