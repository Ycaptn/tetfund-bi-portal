...
class CreateTfBiTpNominationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tf_bi_tp_nominations', function (Blueprint $table) {
            ...
            $table->string('rank_gl_equivalent')->nullable();
            $table->decimal('dta_amount_requested', 15, 2)->nullable();
            $table->decimal('dta_amount_approved', 15, 2)->nullable();
            $table->decimal('dta_nights_amount_requested', 15, 2)->nullable();
            $table->decimal('dta_nights_amount_approved', 15, 2)->nullable();
            $table->decimal('local_runs_amount_requested', 15, 2)->nullable();
            $table->decimal('local_runs_amount_approved', 15, 2)->nullable();
            $table->decimal('taxi_fare_amount_requested', 15, 2)->nullable();
            $table->decimal('taxi_fare_amount_approved', 15, 2)->nullable();
    ...
    {
        Schema::drop('tf_bi_tp_nominations');
    }
}
