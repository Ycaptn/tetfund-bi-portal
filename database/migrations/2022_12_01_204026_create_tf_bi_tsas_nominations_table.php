...
class CreateTfBiTSASNominationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tf_bi_tsas_nominations', function (Blueprint $table) {
            ...
            //$table->foreignUuid('institution_id')->references('id')->on('tf_astd_conferences');
            ...
            $table->string('intl_passport_number');
            $table->string('bank_verification_number');
            $table->string('national_id_number');
            $table->string('organizer_name');
            $table->string('conference_theme');
            $table->string('accepted_paper_title');
            $table->string('attendee_department_name');
            $table->string('attendee_grade_level');
    ...
    {
        Schema::drop('tf_bi_tsas_nominations');
    }
}
